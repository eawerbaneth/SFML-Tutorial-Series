...
void player::adjust(float x_offset, float y_offset){
...
bool player::kick(sf::Vector2f enemy_pos, std::string enemy_state){
	...
	Sprite.Resize(Sprite.GetSize().x+100, Sprite.GetSize().y);
...
special_attack* player::special(sf::Vector2f pos, bool dir){
	return NULL;
}